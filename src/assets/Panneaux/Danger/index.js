...
export default [
  {
    img: A1a,
    choices: [
      "Rétrécissement de chaussée par la droite",
      "Virage a gauche",
      "Virage a droite",
      "Série de virages dont le premire est à droite",
    ],
    solution: 2,
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      "Dos-d'âne",
      "Chausse glissante",
      "Arret obligatoire a l'intersection",
    ],
    solution: 1,
  },
  {
    ...
    choices: [
      ...
      "Rétrécissement de chaussée par la gauche",
      "Croisement avec feux tricolores",
  ...
  },
  {
    ...
    choices: [
      "vent lateral",
      "Route a caractre prioritaire",
      "Priorite a droite",
      "Ralentire danger non specifie",
    ],
    solution: 2,
  },
  {
    ...
    choices: [
      "Série de virages dont le premire est à droite",
      "Dos-d'âne",
      "Intersection ou vous etres prioritaire",
      "fin de route a caractere prioritaire",
    ],
    solution: 2,
  },
  {
    ...
    choices: [
      "Sens inverse",
      "Arret obligatoire a l'intersection",
      "Passage a niveau a fonctionnement manuel",
      "Route a caractre prioritaire",
    ],
    solution: 1,
  },
  {
    ...
    choices: [
      "travaux temporaire",
      "Passage a niveau sans barriere ni demi-barriere",
      "Priorite a droite",
      "Croisement avec feux tricolores",
    ],
    solution: 0,
