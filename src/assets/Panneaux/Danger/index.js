...
export default [
  ...
  { img: A17, choices: ["Rétrécissement de chaussée","Croisement avec feux tricolores","Debouche de cyckustes",""], solution: 1 },
  ...
  { img: ic_stop, choices: ["Sens inverse","Arret obligatoire a l'intersection","Passage a niveau a fonctionnement manuel",""], solution: 1 },
