...
export const Items = [
  ...
  },
  {
    ...
    title: "Rond-point",
    description:
      "Il faut céder le passage à celui qui entre dans le rond-point. Si je suis déjà engagé, je cède le passage à celui qui arrive sur ma droite et si j'entre dans le rond-point, je suis prioritaire. ",
    src: A2,
  ...
  },
  {
    ...
    description:
      "Dans ce cas la priorite est par le signe de panneaux decide ,il faut respecte ",
    src: A3,
  ...
  },
  {
    key: 4,
    title: "Les intersections avec panneau",
    description: "Un autre panneau qui dicide la priorité",
    src: A4,
